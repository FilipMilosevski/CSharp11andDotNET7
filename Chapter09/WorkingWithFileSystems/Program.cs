...
WriteLine($"Working wirh : {newFolder}");
...
SectionTitle("Getting the information");
...
string myPath = @"C:\Users\PC\Documents\Visual Studio 2022\Visualizers\attribcache140.bin";
FileInfo info2 = new(myPath);
WriteLine($"{myPath}:");
WriteLine($"Contains {info2.Length} bytes");
WriteLine($"Last accesed:{info2.LastAccessTime}");
WriteLine($"Has readonly set to {info2.IsReadOnly}");
